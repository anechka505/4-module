document.addEventListener('DOMContentLoaded', function () {
    ...
    var playBtn = document.getElementById('guide-video-play');
    ...
    if (video && playBtn) {
        ...
        // Клик по самому видео — toggle play/pause (помимо нативных контролов).
    ...
    var buyBtn = document.getElementById('buy-guide-btn');
